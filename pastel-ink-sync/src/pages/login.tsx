  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 p-4">
      <div className="w-full max-w-4xl">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row animate-slide-in">
          {/* Left Side - Sign In Form */}
          <div className="w-full md:w-1/2 p-8 md:p-12 animate-slide-in-left">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full h-12 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-semibold rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
              >
                SIGN IN
              </Button>
            </form>
          ...
          {/* Right Side - Welcome */}
          <div className="w-full md:w-1/2 bg-gradient-to-br from-pink-400 to-red-500 p-8 md:p-12 flex flex-col items-center justify-center text-white animate-slide-in-right">
            <h2 className="text-4xl font-bold mb-4 animate-bounce-in">Hello, Friend!</h2>
